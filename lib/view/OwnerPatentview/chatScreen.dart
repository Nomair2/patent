...
class ChatScreenOwner extends StatefulWidget {
  const ChatScreenOwner({super.key});

  @override
  State<ChatScreenOwner> createState() => _ChatScreenOwnerState();
}

class _ChatScreenOwnerState extends State<ChatScreenOwner> {
  @override
